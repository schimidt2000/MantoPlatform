...
export { useTheme, toggleTheme } from "./lib/theme";
export type { Theme, RevealOrigin } from "./lib/theme";
...
export { Foto } from "./components/foto";
export type { FotoProps } from "./components/foto";
