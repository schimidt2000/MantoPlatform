...
const SECTIONS: NavSectionConfig[] = [
    ...
    items: [
      {
        ...
        href: "/figurinos",
        icon: <Shirt />,
        hint: "Fichas dos personagens",
        isActive: (path) => path.startsWith("/figurinos") && !path.startsWith("/figurinos/producao"),
        isVisible: notRevendedor,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        // Feature 255 — as tags NFC embutidas nas peças entregues (luminárias).
        key: "3d-tags",
        label: "Tags NFC",
        href: "/3d/tags",
        icon: <Nfc />,
        hint: "Códigos das tags das peças entregues",
        isActive: (path) => path === "/3d/tags",
        isVisible: (user) => notRevendedor(user) && hasRole(user, "ARTISTA_3D", "SUPERADMIN"),
      },
    ],
  },
